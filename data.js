...
// ══════════════════════════════════════════════════════
const CAT_META = {
  "Dessert":            { icon:"🍮", bg:"rgba(192,90,44,0.08)",   grad:"linear-gradient(135deg,#C05A2C,#D4A847)" },
  "Poultry":            { icon:"🍗", bg:"rgba(212,168,71,0.09)",  grad:"linear-gradient(135deg,#D4A847,#7A8C6E)" },
  "Vegetarian":         { icon:"🥦", bg:"rgba(122,140,110,0.09)", grad:"linear-gradient(135deg,#7A8C6E,#2C8A5A)" },
  "Seafood":            { icon:"🦐", bg:"rgba(44,107,138,0.09)",  grad:"linear-gradient(135deg,#2C6B8A,#7A8C6E)" },
  "Salads":             { icon:"🥗", bg:"rgba(122,140,110,0.09)", grad:"linear-gradient(135deg,#7A8C6E,#D4A847)" },
  "Baking":             { icon:"🎂", bg:"rgba(212,168,71,0.09)",  grad:"linear-gradient(135deg,#D4A847,#C05A2C)" },
  "Fish & Seafood":     { icon:"🐟", bg:"rgba(44,107,138,0.09)",  grad:"linear-gradient(135deg,#2C6B8A,#2C8A5A)" },
  "Breakfast":          { icon:"🍳", bg:"rgba(192,90,44,0.08)",   grad:"linear-gradient(135deg,#C05A2C,#D4A847)" },
  "Beef":               { icon:"🥩", bg:"rgba(138,44,44,0.08)",   grad:"linear-gradient(135deg,#8A2C2C,#C05A2C)" },
  "Pork":               { icon:"🥓", bg:"rgba(192,90,44,0.08)",   grad:"linear-gradient(135deg,#C05A2C,#8A2C2C)" },
  "Snacks":             { icon:"🧆", bg:"rgba(212,168,71,0.08)",  grad:"linear-gradient(135deg,#D4A847,#7A8C6E)" },
  "Lamb":               { icon:"🫕", bg:"rgba(138,92,44,0.08)",   grad:"linear-gradient(135deg,#8A5C2C,#C05A2C)" },
  "Pasta":              { icon:"🍝", bg:"rgba(192,136,44,0.09)",  grad:"linear-gradient(135deg,#C0882C,#C05A2C)" },
  "Curries":            { icon:"🍛", bg:"rgba(139,75,139,0.09)",  grad:"linear-gradient(135deg,#8B4B8B,#C05A2C)" },
  "Pickles & Chutneys": { icon:"🫙", bg:"rgba(122,140,110,0.09)", grad:"linear-gradient(135deg,#7A8C6E,#D4A847)" },
  "Soup & Noodles":     { icon:"🍜", bg:"rgba(44,107,138,0.09)",  grad:"linear-gradient(135deg,#2C6B8A,#7A8C6E)" },
  "Dumplings":          { icon:"🥟", bg:"rgba(192,90,44,0.08)",   grad:"linear-gradient(135deg,#C05A2C,#D4A847)" },
  "Basics":             { icon:"🧂", bg:"rgba(107,76,53,0.08)",   grad:"linear-gradient(135deg,#6B4C35,#9C8B7A)" },
  "Risotto":            { icon:"🍚", bg:"rgba(192,136,44,0.09)",  grad:"linear-gradient(135deg,#C0882C,#D4A847)" },
  "Game":               { icon:"🦌", bg:"rgba(107,76,53,0.08)",   grad:"linear-gradient(135deg,#6B4C35,#8A2C2C)" }
};
